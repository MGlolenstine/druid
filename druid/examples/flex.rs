            ...
            Flex::column()
                .with_child(
                    Flex::row()
                        .with_child(
                            Checkbox::new()
                                .lens(Params::debug_layout)
                                .padding((0., 0., 8., 0.)),
                            0.,
                        )
                        .with_child(Label::new("Debug layout"), 0.),
                    0.0,
                )
                ...
                .with_child(
                    Flex::row()
                        .with_child(
                            Checkbox::new()
                                .lens(Params::fix_minor_axis)
                                .padding((0., 0., 8., 0.)),
                            0.,
                        )
                        .with_child(Label::new("Fix minor axis size"), 0.),
                    0.,
                )
                .padding(5.0),
            0.0,
...
fn build_widget(state: &Params) -> Box<dyn Widget<AppState>> {
    let alignment = match state.alignment {
        MyAlignment::Stretch => Alignment::Stretch,
